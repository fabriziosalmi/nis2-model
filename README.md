...
| Size thresholds | Simplified (employees OR revenue) — linked/partner enterprise rules per EU Rec. 2003/361/EC not implemented |
| Sub-sector classification | `sub_sector` field accepted but **not used** in decision logic |
| Balance sheet | Accepted as input but **not used** for applicability determination |
| Sector codes | 18 codes (11 Annex I + 7 Annex II) — sub-sector granularity not modeled |
